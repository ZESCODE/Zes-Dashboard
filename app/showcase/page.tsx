...
import { GlassStatCard, type FrostColor } from "@/components/dashboard/glass-stat";
...
function GlassFeatureCard({
  ...
  const tokens: Record<string, { card: string; iconBg: string; iconText: string; accent: string; badgeBg: string; badgeText: string }> = {
    green: { card: 'glass-frost-green', iconBg: 'bg-emerald-500/15', iconText: 'text-emerald-300', accent: 'text-emerald-300', badgeBg: 'bg-emerald-500/15', badgeText: 'text-emerald-300' },
    blue: { card: 'glass-frost-blue', iconBg: 'bg-blue-500/15', iconText: 'text-blue-300', accent: 'text-blue-300', badgeBg: 'bg-blue-500/15', badgeText: 'text-blue-300' },
    orange: { card: 'glass-frost-orange', iconBg: 'bg-orange-500/15', iconText: 'text-orange-300', accent: 'text-orange-300', badgeBg: 'bg-orange-500/15', badgeText: 'text-orange-300' },
    red: { card: 'glass-frost-red', iconBg: 'bg-red-500/15', iconText: 'text-red-300', accent: 'text-red-300', badgeBg: 'bg-red-500/15', badgeText: 'text-red-300' },
  };
  const t = tokens[frost];
  return (
...
export default function ShowcasePage() {
  ...
  return (
    <DashboardPageLayout
      header={{
        title: "Design Hub",
        description: "Frost design system — components, glass palette, and system stat cards",
        icon: Sparkles,
      }}
    >
      {/* ── 1. GLASS STAT CARDS ── */}
