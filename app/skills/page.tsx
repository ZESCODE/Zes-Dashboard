...
const fallbackSkills: Skill[] = [
  ...
  { name: "bitrouter-integration", category: "Integration", description: "Use when working with BitRouter AI gateway — LLM chat/code generation, vector embeddings, web search, URL fetching.", origin: "ECC" },
  { name: "ZES-bitrouter", category: "ZES", description: "BitRouter AI Gateway management — model routing, API key management, provider configuration.", version: "1.0.0", origin: "ZES" },
